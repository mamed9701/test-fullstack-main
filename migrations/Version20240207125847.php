    ...
    AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE clocking (id INT AUTO_INCREMENT NOT NULL, duration INT NOT NULL, clocking_project_id INT NOT NULL, clocking_user_id INT NOT NULL, INDEX IDX_D3E9DCCD4431A71B (clocking_project_id), INDEX IDX_D3E9DCCDA1F846FC (clocking_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('CREATE TABLE `user` (id INT AUTO_INCREMENT NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, matricule VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_8D93D64912B2DC9C (matricule), date DATE NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        ...
        for($index = 1; $index <= $nbUsers; $index++) {
            ...
            $this->addSql("INSERT INTO user (id, first_name, last_name, matricule, date) VALUES ($index, \"$firstName\", \"$lastName\", \"$matricule\", '$date')");
        }
        ...
        for($index = 1; $index <= $nbClockings; $index++) {
            ...
            $this->addSql("INSERT INTO clocking (id, duration, clocking_project_id, clocking_user_id) VALUES ($index, $duration, $project, $user)");
        }
    }
}
